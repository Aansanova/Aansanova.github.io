					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="info">
							...
							<div class="right-area">
								<h5>Perumahan Tirtayasa Indah</h5>
								<h5>Sukabumi,Bandar Lampung 35134</h5>
							</div><!-- right-area -->
						</div><!-- info -->
					</div><!-- col-sm-4 -->
			...
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						...
						<h2><b>Aan Sanova</b></h2>
						<h4 class="font-yellow">Informatics Engineering students at the Sumatra Institute of Technology </h4>
						<ul class="information margin-tb-30">
							<li><b>BORN : </b>October 08, 1997</li>
							<li><b>EMAIL : </b>aansanova48@gmail.com</li>
							<li><b>MARITAL STATUS : </b>Single</li>
						</ul>
						<ul class="social-icons">
							<li><a href="#"><i class="ion-social-pinterest"></i></a></li>
							<li><a href="https://www.linkedin.com/in/aan-sanova-6a7b93109/"><i class="ion-social-linkedin"></i></a></li>
							<li><a href="https://www.instagram.com/aansanova"><i class="ion-social-instagram"></i></a></li>
							<li><a href="https://www.facebook.com/papzaan"><i class="ion-social-facebook"></i></a></li>
			...
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6 col-lg-3">
							<div class="radial-prog-area margin-b-30">
								<div class="radial-progress" data-prog-percent=".87">
									<div></div>
						...
						<div class="col-sm-6 col-md-6 col-lg-3">
							<div class="radial-prog-area margin-b-50">
								<div class="radial-progress" data-prog-percent=".77">
									<div></div>
				...
				<div class="col-sm-8">
					<div class="education-wrapper">
						<div class="education margin-b-50">
							<h4><b>SD NEGERI 1 SUKABUMI INDAH</b></h4>
							<h6 class="font-lite-black margin-t-10">2005 - 2010</h6>
						</div><!-- education -->
						
						<div class="education margin-b-50">
							<h4><b>SMP NEGERI 31 BANDAR LAMPUNG</b></h4>
							<h6 class="font-lite-black margin-t-10">2010 - 2013</h6>
						
						</div><!-- education -->
						
						<div class="education margin-b-50">
							<h4><b>SMK NEGERI 5 BANDAR LAMPUNG</b></h4>
							<h5 class="font-yellow"><b>MULTIMEDIA</b></h5>
							<h6 class="font-lite-black margin-t-10">2013 - 2016</h6>


						</div><!-- education -->
						<div class="education margin-b-50">
							<h4><b>INSTITUT TEKNOLOGI SUMATERA</b></h4>
							<h5 class="font-yellow"><b>TEKNIK INFORMATIKA</b></h5>
							<h6 class="font-lite-black margin-t-10">2016 - Sekarang</h6>
